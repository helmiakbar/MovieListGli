...
extension UIImageView {
    ...
    func setImage(_ url: String, placeholder: String? = "ic_image_placeholder") {
    ...
    func loadImage(url: URL?, placeholder: String = "ic_default_user") {
        kf.setImage(with: url, placeholder: UIImage(named: placeholder),
                    options: [.transition(.fade(0.33)),
                              .memoryCacheExpiration(.seconds(60))])
    }
    
    func loadImage(url: URL?, size: CGSize, placeholder: String = "ic_default_user") {
